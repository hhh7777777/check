...
export const importAttendees = (data) => request.post('/admin/attendees/import', data)
...
export const exportAttendees = (params) => request.get('/admin/attendees/export', { params })
...
export const uploadLiveImage = (data) => request.post('/admin/live-images', data)
